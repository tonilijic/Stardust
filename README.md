## Experiment Goal
In the limited time, (roughly 3-4 hours) use the [stardust.style](https://stardust.style) to redesign the homepage of selected site: [https://wasp.sh](https://wasp.sh). 
Check its output, inject corrections, loop until satisfied or time's up, and deploy it in test environment.
...
## Stardust Output
Full screenshots can be found under [screenshots](screenshots)

- Direction 1 (The corrected spec — brand-faithful, ships the declared system literally)

- Direction 2 (The schematic — the blueprint/circuit-diagram trait pushed as the page's structure)

- Direction 3 (The spec document — the numbered-eyebrow trait pushed into a running RFC structure)
...
## What I overrode
All overrides are mentioned in [Override.md](Override.md) file.
